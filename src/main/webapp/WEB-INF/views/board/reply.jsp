			...
			<div class="col-lg-12">
				...
				<!--  /.panel-heading -->
					<div class="panel-body">
						<!--  등록 form -->
						<form role="form" action="/board/reply" method="post" id="submitForm">
							<div class="form-group">
								<label>제목</label> <input class="form-control" name="brd_title" value="	 [RE]${reply.brd_title}" readonly>
							</div>
							<div class="form-group">
								<label>내용</label>
							...
							<input type="hidden" id="brd_groupOrd" name="brd_groupOrd" value="${reply.brd_groupOrd + 1}"/>
							<input type="hidden" id="brd_orginNo" name="brd_orginNo" value="${reply.brd_orginNo}"/>
							<input type="hidden" id="brd_table" name="brd_table" value="${reply.brd_table}"/>
